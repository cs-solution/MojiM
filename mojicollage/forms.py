...
class createInfo(forms.Form):
    ...
    myName = forms.CharField(label="自分の名前", required=False, max_length=20)
    myAge = forms.IntegerField(label="自分の年齢", required=False)
    tgtName = forms.CharField(label="女の子の名前", required=False, max_length=20)
    tgtAge = forms.IntegerField(label="女の子の年齢", required=False)
